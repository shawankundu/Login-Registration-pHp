<?php
   include '_db_con.php';
    ...
    $delete = false;
    session_start();
    if(!isset($_SESSION['usr_loggedin']) || $_SESSION['usr_loggedin'] != true){
...
<body>
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodalLabel"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="mx-1 mx-md-4" action="/login_registration_crud/usr_dashboard.php" method="POST">
  ...
  ?>
    ...
    <div class="d-flex justify-content-end"><a href="logout.php">logout</a></div>
    <!-- </div> -->
    <table class="table" id="myTable">
      ...
      <tbody>
          ...
          // $sql = "select * from `registration_user` where email = "$_SESSION['email']" AND name = "$_SESSION['name']" ";
          // $result = mysqli_query($conn, $sql);
          // $num = mysqli_num_rows($result);
          // if($num == 1){
            // $row = mysqli_fetch_assoc($result);
          echo "<tr>
          <th scope='row'>".$_SESSION['slno']."</th>
          <td>".$_SESSION['name']."</td>
          <td>".$_SESSION['email']."</td>
          <td><button class='edit btn btn-primary' id=".$_SESSION['slno'].">Edit</button></td>
        </tr>";
          // }
          ?>
